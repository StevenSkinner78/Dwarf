 ...
 */
package gov.doc.isu.dwarf.taglib.displaytag.properties;
...
import gov.doc.isu.dwarf.taglib.displaytag.decorator.DecoratorFactory;
import gov.doc.isu.dwarf.taglib.displaytag.decorator.DefaultDecoratorFactory;
import gov.doc.isu.dwarf.taglib.displaytag.exception.FactoryInstantiationException;
import gov.doc.isu.dwarf.taglib.displaytag.exception.TablePropertiesLoadException;
import gov.doc.isu.dwarf.taglib.displaytag.localization.I18nResourceProvider;
import gov.doc.isu.dwarf.taglib.displaytag.localization.LocaleResolver;
import gov.doc.isu.dwarf.taglib.displaytag.model.DefaultComparator;
import gov.doc.isu.dwarf.taglib.displaytag.util.DefaultRequestHelperFactory;
import gov.doc.isu.dwarf.taglib.displaytag.util.ReflectHelper;
import gov.doc.isu.dwarf.taglib.displaytag.util.RequestHelperFactory;
...
public final class TableProperties implements Cloneable {
    ...
    /**
     * property <code>export.pdf.header</code>.
     */
    public static final String PROPERTY_STRING_EXPORTPDF_HEADER = "export.pdf.header"; //$NON-NLS-1$

    /**
     * property <code>export.pdf.footer</code>.
     */
    public static final String PROPERTY_STRING_EXPORTPDF_FOOTER = "export.pdf.footer"; //$NON-NLS-1$
    ...
    /**
     * property <code>css.table</code>: holds the name of the css class added to the main table tag. By default no css class is added.
     */
    public static final String PROPERTY_CSS_TABLE = "css.table"; //$NON-NLS-1$

    /**
     * property <code>css.th.sortable</code>: holds the name of the css class added to the the header of a sortable column. By default no css class is added.
     */
    public static final String PROPERTY_CSS_TH_SORTABLE = "css.th.sortable"; //$NON-NLS-1$

    /**
     * property <code>css.th.sorted</code>: holds the name of the css class added to the the header of a sorted column. Defaults to <code>sorted</code>.
     */
    public static final String PROPERTY_CSS_TH_SORTED = "css.th.sorted"; //$NON-NLS-1$

    /**
     * property <code>css.th.ascending</code>: holds the name of the css class added to the the header of a column sorted in ascending order. Defaults to <code>order1</code>.
     */
    public static final String PROPERTY_CSS_TH_SORTED_ASCENDING = "css.th.ascending"; //$NON-NLS-1$

    /**
     * property <code>css.th.descending</code>: holds the name of the css class added to the the header of a column sorted in descending order. Defaults to <code>order2</code>.
     */
    public static final String PROPERTY_CSS_TH_SORTED_DESCENDING = "css.th.descending"; //$NON-NLS-1$

    /**
     * prefix used for all the properties related to export ("export"). The full property name is <code>export.</code> <em>[export type]</em><code>.</code><em>[property name]</em>
     */
    public static final String PROPERTY_EXPORT_PREFIX = "export"; //$NON-NLS-1$

    /**
     * prefix used to set the media decorator property name. The full property name is <code>decorator.media.</code><em>[export type]</em>.
     */
    public static final String PROPERTY_DECORATOR_SUFFIX = "decorator"; //$NON-NLS-1$

    /**
     * used to set the media decorator property name. The full property name is <code>decorator.media.</code><em>[export type]</em>
     */
    ...
    /**
     * Property <code>pagination.sort.param</code>. If external pagination and sorting is used, it holds the name of the parameter used to hold the sort criterion in generated links
     */
    public static final String PROPERTY_STRING_PAGINATION_SORT_PARAM = "pagination.sort.param"; //$NON-NLS-1$

    /**
     * Property <code>pagination.sortdirection.param</code>. If external pagination and sorting is used, it holds the name of the parameter used to hold the sort direction in generated links (asc or desc)
     */
    ...
    /**
     * Property <code>pagination.sort.asc.value</code>. If external pagination and sorting is used, it holds the value of the parameter of the sort direction parameter for "ascending"
     */
    public static final String PROPERTY_STRING_PAGINATION_ASC_VALUE = "pagination.sort.asc.value"; //$NON-NLS-1$

    /**
     * Property <code>pagination.sort.desc.value</code>. If external pagination and sorting is used, it holds the value of the parameter of the sort direction parameter for "descending"
     */
    ...
    /**
     * Property <code>pagination.sort.image.path</code>. This holds the path for the sort image
     */
    public static final String PROPERTY_STRING_PAGINATION_SORT_IMAGE_PATH = "pagination.sort.image.path"; //$NON-NLS-1$

    /**
     * Property <code>pagination.sort.asc.image.path</code>. This holds the path for the sort ascending image path
     */
    public static final String PROPERTY_STRING_PAGINATION_SORT_ASC_IMAGE_PATH = "pagination.sort.asc.image.path"; //$NON-NLS-1$

    /**
     * Property <code>pagination.sort.desc.image.path</code>. This holds the path for the sort descending image path
     */
    public static final String PROPERTY_STRING_PAGINATION_SORT_DESC_IMAGE_PATH = "pagination.sort.desc.image.path"; //$NON-NLS-1$

    /**
     * Property <code>comparator.default</code>. If present, will use use as the classname of the default comparator. Will be overriden by column level comparators.
     */
    ...
    /**
     * property <code>searchrow.wrapper</code>.
     */
    public static final String PROPERTY_STRING_SEARCHROW_WRAPPER = "searchrow.wrapper";

    /**
     * property <code>show.pagesize.dropdown</code>.
     */
    public static final String PROPERTY_BOOLEAN_SHOWPAGESIZEDROPDOWN = "show.pagesize.dropdown";

    /**
     * property <code>pagesize.dropdown.wrapper</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_WRAPPER = "pagesize.dropdown.wrapper";

    /**
     * property <code>pagesize.dropdown.label.one</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_LABEL_ONE = "pagesize.dropdown.label.one";

    /**
     * property <code>pagesize.dropdown.label.two</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_LABEL_TWO = "pagesize.dropdown.label.two";
    /**
     * property <code>pagesize.dropdown.label.one.styleClass</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_LABEL_ONE_STYLE = "pagesize.dropdown.label.one.styleClass";

    /**
     * property <code>pagesize.dropdown.label.two.styleClass</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_LABEL_TWO_STYLE = "pagesize.dropdown.label.two.styleClass";
    /**
     * property <code>pagesize.dropdown.style</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_STYLE = "pagesize.dropdown.style";
    /**
     * property <code>pagesize.dropdown.formName</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_FORM_NAME = "pagesize.dropdown.formName";
    /**
     * property <code>pagesize.dropdown.action</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_ACTION = "pagesize.dropdown.action";
    /**
     * property <code>pagesize.dropdown.method</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_METHOD = "pagesize.dropdown.method";
    /**
     * property <code>pagesize.dropdown.type</code>.
     */
    public static final String PROPERTY_STRING_PAGESIZE_TYPE = "pagesize.dropdown.type";

    public static final String PROPERTY_STRING_PAGESIZE_USE_ALL = "pagesize.dropdown.use.all";
     ...
     * logger.
     */
    private static Logger log = Logger.getLogger(TableProperties.class);
    ...
    /**
     * Configured resource provider. If no ResourceProvider is configured, an no-op one is used. This instance is initialized at first use and shared.
     */
     ...
     * @throws TablePropertiesLoadException
     *         if the default <code>TableTag.properties</code> file is not found.
     */
            ...
            if(className != null){
                try{
                    ...
                    log.warn(Messages.getString("TableProperties.errorloading", //$NON-NLS-1$
                            new Object[]{ClassUtils.getShortClassName(LocaleResolver.class), e.getClass().getName(), e.getMessage()}));
                }
            }else{
    ...
    public boolean getExportHeader(MediaTypeEnum exportType) {
        return getBooleanProperty(PROPERTY_EXPORT_PREFIX + SEP + exportType.getName() + SEP + EXPORTPROPERTY_BOOLEAN_EXPORTHEADER);
    }
    ...
    /**
     * Getter for the <code>PROPERTY_STRING_EXPORTPDF_HEADER</code> property.
     * 
     * @return String
     */
    public String getExportPdfHeader() {
        return getProperty(PROPERTY_STRING_EXPORTPDF_HEADER);
    }

    /**
     * Getter for the <code>PROPERTY_STRING_EXPORTPDF_FOOTER</code> property.
     * 
     * @return String
     */
    public String getExportPdfFooter() {
        return getProperty(PROPERTY_STRING_EXPORTPDF_FOOTER);
    }
     ...
     * @param rowNumber
     *        row number
     * @return the value of <code>PROPERTY_CSS_TR_EVEN</code> if rowNumber is even or <code>PROPERTY_CSS_TR_ODD</code> if rowNumber is odd.
     */
     ...
     * @return the value of <code>PROPERTY_CSS_TH_SORTED_ASCENDING</code> if column is sorded in ascending order or <code>PROPERTY_CSS_TH_SORTED_DESCENDING</code> if column is sorded in descending order.
     */
     ...
     *         if unable to load or instantiate the configurated class.
     */
    public RequestHelperFactory getRequestHelperFactoryInstance() throws FactoryInstantiationException {
        ...
        try{
            ...
            throw new FactoryInstantiationException(getClass(), PROPERTY_CLASS_REQUESTHELPERFACTORY, loadedObject.getClass().getName(), e);
        }
    }
    ...
    public DecoratorFactory getDecoratorFactoryInstance() throws FactoryInstantiationException {
        ...
        try{
            ...
            throw new FactoryInstantiationException(getClass(), PROPERTY_CLASS_DECORATORFACTORY, loadedObject.getClass().getName(), e);
        }
    }
    ...
    /**
     * Getter for the <code>PROPERTY_STRING_PAGINATION_SORT_IMAGE_PATH</code> property.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGINATION_SORT_IMAGE_PATH</code>
     */
    public String getPaginationSortImagePath() {
        return getProperty(PROPERTY_STRING_PAGINATION_SORT_IMAGE_PATH);
    }

    /**
     * Getter for the <code>PROPERTY_STRING_PAGINATION_SORT_ASC_IMAGE_PATH</code> property.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGINATION_SORT_ASC_IMAGE_PATH</code>
     */
    public String getPaginationSortAscImagePath() {
        return getProperty(PROPERTY_STRING_PAGINATION_SORT_ASC_IMAGE_PATH);
    }

    /**
     * Getter for the <code>PROPERTY_STRING_PAGINATION_SORT_DESC_IMAGE_PATH</code> property.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGINATION_SORT_DESC_IMAGE_PATH</code>
     */
    public String getPaginationSortDescImagePath() {
        return getProperty(PROPERTY_STRING_PAGINATION_SORT_DESC_IMAGE_PATH);
    }

    /**
     * Getter for the <code>PROPERTY_STRING_SEARCHROW_WRAPPER</code> property.
     * 
     * @return the value of <code>PROPERTY_STRING_SEARCHROW_WRAPPER</code>
     */
    public String getSearchRowWrapper() {
        return getProperty(PROPERTY_STRING_SEARCHROW_WRAPPER);
    }

    /**
     * Getter for the <code>PROPERTY_BOOLEAN_SHOWPAGESIZEDROPDOWN</code> property.
     * 
     * @return boolean
     */
    public boolean getShowPageSizeDropDown() {
        return getBooleanProperty(PROPERTY_BOOLEAN_SHOWPAGESIZEDROPDOWN);
    }

    /**
     * Getter for the <code>PROPERTY_STRING_PAGESIZE_WRAPPER</code> property.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_WRAPPER</code>
     */
    public String getPageSizeWrapper() {
        return getProperty(PROPERTY_STRING_PAGESIZE_WRAPPER);
    }

    /**
     * Returns the first label for page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_LABEL_ONE</code>
     */
    public String getPageSizeLabelOne() {
        return getProperty(PROPERTY_STRING_PAGESIZE_LABEL_ONE);
    }

    /**
     * Returns the second label for page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_LABEL_TWO</code>
     */
    public String getPageSizeLabelTwo() {
        return getProperty(PROPERTY_STRING_PAGESIZE_LABEL_TWO);
    }

    /**
     * Returns the first label style class for page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_LABEL_ONE_STYLE</code>
     */
    public String getPageSizeLabelOneStyle() {
        return getProperty(PROPERTY_STRING_PAGESIZE_LABEL_ONE_STYLE);
    }

    /**
     * Returns the second label style classfor page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_LABEL_TWO_STYLE</code>
     */
    public String getPageSizeLabelTwoStyle() {
        return getProperty(PROPERTY_STRING_PAGESIZE_LABEL_TWO_STYLE);
    }

    /**
     * Returns the css class names for the page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_STYLE</code>
     */
    public String getPageSizeStyle() {
        return getProperty(PROPERTY_STRING_PAGESIZE_STYLE);
    }

    /**
     * Returns the form name to be used in page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_FORM_NAME</code>
     */
    public String getPageSizeFormName() {
        return getProperty(PROPERTY_STRING_PAGESIZE_FORM_NAME);
    }

    /**
     * Returns the action that is associated with the page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_ACTION</code>
     */
    public String getPageSizeAction() {
        return getProperty(PROPERTY_STRING_PAGESIZE_ACTION);
    }

    /**
     * Returns the method that is associated with the page size dropdown. Defaults to changePageSize
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_METHOD</code>
     */
    public String getPageSizeMethod() {
        return getProperty(PROPERTY_STRING_PAGESIZE_METHOD);
    }

    /**
     * Returns the type of page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_TYPE</code>
     */
    public String getPageSizeType() {
        return getProperty(PROPERTY_STRING_PAGESIZE_TYPE);
    }

    /**
     * Returns the string representation of whether to use All option in page size dropdown.
     * 
     * @return the value of <code>PROPERTY_STRING_PAGESIZE_USE_ALL</code>
     */
    public String getPageSizeUseAll() {
        return getProperty(PROPERTY_STRING_PAGESIZE_USE_ALL);
    }
        ...
        if(resourceProvider == null){
            if(className != null){
                try{
                    ...
                    log.warn(Messages.getString("TableProperties.errorloading", //$NON-NLS-1$
                            new Object[]{ClassUtils.getShortClassName(I18nResourceProvider.class), e.getClass().getName(), e.getMessage()}));
                }
            }else{
                log.info(Messages.getString("TableProperties.noconfigured", //$NON-NLS-1$
    ...
    /**
     * Returns an instance of a configured Class. Returns a configured Class instantiated callingClass.forName([configuration value]).
     * 
     * @param key
     *        configuration key
    ...
    public Comparator getDefaultComparator() {
        ...
        if(className != null){
            try{
                ...
                log.warn(Messages.getString("TableProperties.errorloading", //$NON-NLS-1$
                        new Object[]{ClassUtils.getShortClassName(Comparator.class), e.getClass().getName(), e.getMessage()}));
            }
        }
