...
public class TableModel {
    ...
    private CommonModel offenderInfo;
    ...
    /**
     * @return the offenderInfo
     */
    public CommonModel getOffenderInfo() {
        return offenderInfo;
    }

    /**
     * @param offenderInfo
     *        the offenderInfo to set
     */
    public void setOffenderInfo(CommonModel offenderInfo) {
        this.offenderInfo = offenderInfo;
    }
    ...
    public HeaderCell getSortedColumnHeader() {
        if(this.sortedColumn < 0 || (this.sortedColumn > (this.headerCellList.size() - 1 + exportColOffset))){
            return null;
        }
        return (HeaderCell) this.headerCellList.get(this.sortedColumn - exportColOffset);
    }
     ...
     * @return RowIterator
     * @param full
     *        if <code>true</code> returns an iterator on te full list, if <code>false</code> only on the viewable part.
     * @see gov.doc.isu.dwarf.taglib.displaytag.model.RowIterator
     */
        ...
        if(isSorted()){
            ...
            if(sortedHeaderCell != null){
                ...
                if(sortedHeaderCell.getBeanPropertyName() != null || (this.sortedColumn != -1 && this.sortedColumn < this.headerCellList.size())){
                    ...
                    // Check if a sortType is specified
                    String sortType = (sortedHeaderCell.getSortType() != null) ? sortedHeaderCell.getSortType() : null;

                    Collections.sort(list, new RowSorter(this.sortedColumn, sorted, sortType, getTableDecorator(), this.sortOrderAscending, sortedHeaderCell.getComparator()));
