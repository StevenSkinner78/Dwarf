...
abstract class Decorator {
    ...
    public boolean hasGetterFor(String propertyName) {
        ...
        Boolean cachedResult = (Boolean) propertyMap.get(getClass().getName() + CLASS_PROPERTY_SEPARATOR + simpleProperty);
        ...
        // save in cache
        propertyMap.put(getClass().getName() + CLASS_PROPERTY_SEPARATOR + simpleProperty, BooleanUtils.toBooleanObject(hasGetter));
