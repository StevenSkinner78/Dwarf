...
public class DefaultDecoratorFactory implements DecoratorFactory {
     ...
     * <li>If not found, assume <code>decoratorName</code> is the class name of the decorator and load it using reflection</li>
     * </ul>
     * 
     * @param decoratorName
    ...
    /**
     * Wrapper class for handling decorators implementing the deprecated ColumnDecorator interface as 1.1 <code>DisplaytagColumnDecorator</code>s.
     */
