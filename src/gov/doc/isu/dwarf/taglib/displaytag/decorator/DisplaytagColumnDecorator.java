 ...
 * </p>
 * <p>
 * The <code>DisplaytagColumnDecorator</code> interface has been introduced in displaytag 1.1 and replaces the previous <code>ColumnDecorator</code> interface, adding the pageContext and media parameters, and changing the return type to object to allow decorator chaining.
 * </p>
 * 
