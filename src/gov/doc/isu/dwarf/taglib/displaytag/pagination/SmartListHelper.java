...
public class SmartListHelper {
     ...
     * logger.
     */
    private static Logger log = Logger.getLogger(SmartListHelper.class);
     ...
     *        TableProperties
     */
    public SmartListHelper(List list, int fullSize, int itemsInPage, TableProperties tableProperties, boolean partialList) {
     ...
     * @param pageNumber
     *        page number
     * @return List subsection of the list that contains just the elements that are supposed to be shown on the given page
     */
    ...
    public String getSearchResultsSummary() {
        ...
        if(this.fullListSize == 0){
            ...
            objs = new Object[]{new Integer(this.fullListSize), this.properties.getPagingItemsName(), new Integer(getFirstIndexForCurrentPage() + 1), new Integer(getLastIndexForCurrentPage() + 1), new Integer(this.currentPage), new Integer(this.pageCount)};
