...
public class PaginatedListSmartListHelper extends SmartListHelper {
    ...
    public String getSearchResultsSummary() {
        ...
        if(this.paginatedList.getFullListSize() == 0){
            ...
            objs = new Object[]{new Integer(this.paginatedList.getFullListSize()), this.properties.getPagingItemsName(), new Integer(getFirstIndexForCurrentPage() + 1), new Integer(getLastIndexForCurrentPage() + 1), new Integer(this.paginatedList.getPageNumber()), new Integer(pageCount)};
