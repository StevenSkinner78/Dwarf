...
public final class ExportDelegate {
     ...
     * logger.
     */
    private static Logger log = Logger.getLogger(ExportDelegate.class);
    ...
    /**
     * Actually writes exported data. Extracts content from the Map stored in request with the <code>TableTag.FILTER_CONTENT_OVERRIDE_BODY</code> key.
     * 
     * @param wrapper
