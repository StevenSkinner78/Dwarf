 ...
 * </pre>
 * <p>
 * By default the filter buffers all the export content before writing it out. You can set an optional parameter <code>buffer</code> to <code>false</code> to make the filter write directly to the output stream. This could be faster and uses less memory, but the content length will not be set.
 * </p>
 * 
 * <pre>
 *  &lt;filter>
...
public class ResponseOverrideFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        log = Logger.getLogger(ResponseOverrideFilter.class);
