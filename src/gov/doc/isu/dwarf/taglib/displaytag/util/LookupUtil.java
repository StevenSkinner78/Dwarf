...
public final class LookupUtil {
     ...
     * logger.
     */
    private static Logger log = Logger.getLogger(LookupUtil.class);
     ...
     * </p>
     * <p>
     * Handle <code>NestedNullException</code> returning nulls and other exceptions returning <code>ObjectLookupException</code>.
     * </p>
     * 
     * @param bean
     *        javabean
    ...
    public static Object getBeanProperty(Object bean, String name) throws ObjectLookupException {
        ...
        try{
            ...
            log.debug("Caught IllegalArgumentException from beanutils while looking up " + name + " in bean " + bean, e);
            return null;
        }
    }
     ...
     * @throws BeanPropertyLookupException
     *         in caso di errori nella lettura di proprietà del bean
     */
    public static Object getProperty(Object bean, String name) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        ...
        while(true){
            ...
            if(indexOfMAPPEDDELIM2 >= 0 && indexOfMAPPEDDELIM >= 0 && (indexOfNESTEDDELIM < 0 || indexOfNESTEDDELIM > indexOfMAPPEDDELIM)){
