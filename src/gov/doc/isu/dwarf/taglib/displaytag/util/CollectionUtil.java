...
public final class CollectionUtil {
     ...
     * @return List with values taken from the given object, cropped according to startIndex and numberOfItems parameters
     */
     ...
     * @param numberOfItems
     *        int number of items to keep in the list
     * @return List with values taken from the given object, cropped according the startIndex and numberOfItems parameters
     */
