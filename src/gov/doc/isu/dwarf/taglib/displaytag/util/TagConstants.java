...
public final class TagConstants {
    ...
    /**
     * html <code>div</code> tag name.
     */
    public static final String TAGNAME_DIV = "div"; //$NON-NLS-1$
    ...
    /**
     * html tag <code>%lt;div&gt;</code>.
     */
    public static final String TAG_DIV_OPEN = TAG_OPEN + TAGNAME_DIV + TAG_CLOSE;
    
    /**
     * html tag <code>%lt;/div&gt;</code>.
     */
    public static final String TAG_DIV_CLOSE = TAG_OPENCLOSING + TAGNAME_DIV + TAG_CLOSE;
     ...
     */
    public static final String ATTRIBUTE_ON_CLICK = "onclick"; //$NON-NLS-1$
    ...
    /**
     * html attribute <code>colspan</code>.
     */
    public static final String ATTRIBUTE_COLSPAN = "colspan"; //$NON-NLS-1$
    ...
    /**
     * Empty String "". Used as constant mainly to avoid useless i18n checks and to track use of empty strings (sometimes index of bad code).
     */
    ...
    public static final String ALPHA_NUMERIC_SORT = "alphaNumeric";

    public static final String DATE_SORT = "date";
    public static final String DATE_TIME_SORT = "datetime";
