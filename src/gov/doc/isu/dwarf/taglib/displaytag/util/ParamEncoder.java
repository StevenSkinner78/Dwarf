...
public class ParamEncoder implements Serializable {
    ...
    /**
     * Check if the given parameter has been encoded using paramEncoder. It actually check if the parameter name starts with the calculated <code>parameterIdentifier</code>. Null safe (a null string returns <code>false</code>).
     * 
     * @param paramName
     *        parameter name
