...
public class ColumnTagBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try{
            ...
            proplist.add(new PropertyDescriptor("sortType", //$NON-NLS-1$
                    ColumnTag.class, null, "setSortType")); //$NON-NLS-1$

        }catch(IntrospectionException ex){
            throw new UnhandledException("You got an introspection exception - maybe defining a property that is not" + " defined in the ColumnTag?: " + ex.getMessage(), ex);
        }
