...
/**
 * Beaninfo class for tableTag. Needed to make the "class" tag attribute working and to handle the swith between setName() and setNameString() setters for the name attribute.
 * 
...
public class TableTagBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try{
            proplist.add(new PropertyDescriptor("toggle", //$NON-NLS-1$
                    TableTag.class, null, "setToggle")); //$NON-NLS-1$
            proplist.add(new PropertyDescriptor("toggleAll", //$NON-NLS-1$
                    TableTag.class, null, "setToggleAll")); //$NON-NLS-1$
            ...
            proplist.add(new PropertyDescriptor("offenderPage", //$NON-NLS-1$
                    TableTag.class, null, "setOffenderPage")); //$NON-NLS-1$
            proplist.add(new PropertyDescriptor("tableName", //$NON-NLS-1$
                    TableTag.class, null, "setTableName")); //$NON-NLS-1$
            proplist.add(new PropertyDescriptor("exportColOffset", //$NON-NLS-1$
                    TableTag.class, null, "setExportColOffset")); //$NON-NLS-1$
            ...
            throw new UnhandledException("You got an introspection exception - maybe defining a property that is not" + " defined in the TableTag?: " + ex.getMessage(), ex);
        }
