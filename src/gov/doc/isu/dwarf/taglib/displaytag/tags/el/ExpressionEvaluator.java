...
public class ExpressionEvaluator {
     ...
     * 
     * @param sourceTag
     *        tag where the expression has to be evaluated
     * @param context
     *        the page context
     */
     ...
     * @param returnClass
     *        class the returned object is instance of
     * @throws JspException
     *         exception thrown by ExpressionEvaluatorManager
     */
    public Object eval(String attrName, String attrValue, Class returnClass) throws JspException {
        return attrValue != null ? ExpressionEvaluatorManager.evaluate(attrName, attrValue, returnClass, this.tag, this.pageContext) : null;
    }
