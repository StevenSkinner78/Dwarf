...
public interface I18nResourceProvider {
    ...
    /**
     * Returns a localized String. A resource provider is free to use both <code>resourceKey</code> or <code>defaultValue</code> for the lookup. For example in column titles <code>defaultValue</code> is the value of the <code>property</code> attribute and can be used as a default if <code>titleKey</code> is not specified.
     * 
     * @param resourceKey
