...
/**
 * Struts implementation of a resource provider and locale resolver. Uses Struts <code>RequestUtils.getUserLocale()</code> and <code>TagUtils.message()</code> for the lookup.
 * 
...
public class I18nStrutsAdapter implements I18nResourceProvider, LocaleResolver {
    ...
    public String getResource(String resourceKey, String defaultValue, Tag tag, PageContext pageContext) {
        ...
        MessageResources resources = (MessageResources) pageContext.getAttribute(Globals.MESSAGES_KEY, PageContext.REQUEST_SCOPE);
        ...
        if(resources == null){
            ...
            resources = (MessageResources) pageContext.getAttribute(Globals.MESSAGES_KEY + moduleConfig.getPrefix(), PageContext.APPLICATION_SCOPE);
        }
